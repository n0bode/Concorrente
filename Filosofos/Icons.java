...
public final class Icons{
  public static final BufferedImage SPRITE= loadImage("assets/spritesheet.png"); //Sprite do zombie e do hero
	public static final BufferedImage DESK  = loadImage("assets/desk.png"); //Sprite do zombie e do hero
  public static final BufferedImage FORK  = loadImage("assets/fork.png"); //Sprite do zombie e do hero
